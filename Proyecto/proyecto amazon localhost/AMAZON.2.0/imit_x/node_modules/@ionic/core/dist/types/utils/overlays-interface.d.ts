...
import type { AnimationBuilder, HTMLStencilElement } from '@ionic/core';
...
export type OverlaySelect = HTMLIonActionSheetElement | HTMLIonAlertElement | HTMLIonPopoverElement | HTMLIonModalElement;
